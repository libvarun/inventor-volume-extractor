# inventor.volume.extractor - nodejs
...
Webapp interface that uses Design Automation view volume information of inventor file. Also includes a `Clear Account` (remove all AppBundles and Activities) and `Define new Activity` based on the sample code.
...
Clone this project or download it. It's recommended to install [GitHub Desktop](https://desktop.github.com/). To clone it via command line, use the following (**Terminal** on MacOSX/Linux, **Git Shell** on Windows):
    ...
    git clone https://github.com/libvarun/inventor-volume-extractor.git
...
Varun Patil [@varunpatil](https://twitter.com/varunpatil578), [Forge Partner Development](http://forge.autodesk.com)
